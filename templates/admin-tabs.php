...
$tabs = ['users' => ['/admin/users', 'admin.users.title'], 'index' => ['/admin/index', 'admin.index.title'], 'trash' => ['/admin/trash', 'admin.trash.title'], 'tags' => ['/admin/tags', 'admin.tags.title'], 'maintenance' => ['/admin/maintenance', 'admin.maint.title']];
?>
